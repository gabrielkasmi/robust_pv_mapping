...
def main(args):
    ...
    critic = nn.Sequential( # Same structure for the critic
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for _ in trange(args.iterations, leave=False):
            (source_x, source_y, _), (target_x, _, _) = next(batch_iterator)
            # Train critic
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--iterations', type=int, default=250)
